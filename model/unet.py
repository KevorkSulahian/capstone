...
class RSU7(keras.layers.Layer):
    def __init__(self, mid_ch=12, out_ch=3):
        ...
        self.conv_b0 = REBNCONV(out_ch, dirate=1)

        self.conv_b1 = REBNCONV(mid_ch, dirate=1)
        self.pool1   = MaxPool2D(2, strides=(2, 2))

        self.conv_b2 = REBNCONV(mid_ch, dirate=1)
        self.pool2   = MaxPool2D(2, strides=(2, 2))

        self.conv_b3 = REBNCONV(mid_ch, dirate=1)
        self.pool3   = MaxPool2D(2, strides=(2, 2))

        self.conv_b4 = REBNCONV(mid_ch, dirate=1)
        self.pool4   = MaxPool2D(2, strides=(2, 2))

        self.conv_b5 = REBNCONV(mid_ch, dirate=1)
        self.pool5   = MaxPool2D(2, strides=(2, 2))

        self.conv_b6 = REBNCONV(mid_ch, dirate=1)
        self.conv_b7 = REBNCONV(mid_ch, dirate=2)

        self.conv_b6_d  = REBNCONV(mid_ch, dirate=1)
        self.upsample_1 = UpSampling2D(size=(2, 2), interpolation='bilinear')
        self.conv_b5_d  = REBNCONV(mid_ch, dirate=1)
        self.upsample_2 = UpSampling2D(size=(2, 2), interpolation='bilinear')
        self.conv_b4_d  = REBNCONV(mid_ch, dirate=1)
        self.upsample_3 = UpSampling2D(size=(2, 2), interpolation='bilinear')
        self.conv_b3_d  = REBNCONV(mid_ch, dirate=1)
        self.upsample_4 = UpSampling2D(size=(2, 2), interpolation='bilinear')
        self.conv_b2_d  = REBNCONV(mid_ch, dirate=1)
        self.upsample_5 = UpSampling2D(size=(2, 2), interpolation='bilinear')
        self.conv_b1_d  = REBNCONV(out_ch, dirate=1)
...
class RSU6(keras.layers.Layer):
    def __init__(self, mid_ch=12, out_ch=3):
        ...
        self.conv_b6 = REBNCONV(mid_ch, dirate=2)
...
class RSU5(keras.layers.Layer):
    def __init__(self, mid_ch=12, out_ch=3):
        ...
        self.conv_b5 = REBNCONV(mid_ch, dirate=2)
...
class RSU4(keras.layers.Layer):
    def __init__(self, mid_ch=12, out_ch=3):
        ...
        self.conv_b4 = REBNCONV(mid_ch, dirate=2)
...
class RSU4F(keras.layers.Layer):
    def __init__(self, mid_ch=12, out_ch=3):
        ...
        self.conv_b0 = REBNCONV(out_ch, dirate=1)
        self.conv_b1 = REBNCONV(mid_ch, dirate=1)
        self.conv_b2 = REBNCONV(mid_ch, dirate=2)
        self.conv_b3 = REBNCONV(mid_ch, dirate=4)
        self.conv_b4 = REBNCONV(mid_ch, dirate=8)
        self.conv_b3_d = REBNCONV(mid_ch, dirate=4)
        self.conv_b2_d = REBNCONV(mid_ch, dirate=2)
        self.conv_b1_d = REBNCONV(out_ch, dirate=1)
